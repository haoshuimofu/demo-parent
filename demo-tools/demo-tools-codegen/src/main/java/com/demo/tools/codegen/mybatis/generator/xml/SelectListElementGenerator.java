package com.demo.tools.codegen.mybatis.generator.xml;

import com.demo.tools.codegen.mybatis.contants.MybatisGeneratorConstants;
...
public class SelectListElementGenerator extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        for (IntrospectedColumn introspectedColumn : columns) {
            ...
            selectClause.append(introspectedColumn.getJavaProperty());
            ...
            selectClause.append(" = ");
            selectClause.append(MyBatis3FormattingUtilities.getParameterClause(introspectedColumn, ""));
