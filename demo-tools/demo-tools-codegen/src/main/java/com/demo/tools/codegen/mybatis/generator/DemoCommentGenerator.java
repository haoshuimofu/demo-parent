...
public class DemoCommentGenerator implements CommentGenerator {
    ...
    private static SimpleDateFormat format = new SimpleDateFormat("yyyy-HH-mm hh:mm:ss");
    ...
    public void addModelClassComment(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        if (!suppressAllComments) {
            ...
            topLevelClass.addJavaDocLine(" * @Date " + mbgGenerated + " " + currentDateStr);
...
//            method.addJavaDocLine(" */");
    ...
    public void addMapperInterfaceComment(Interface interfaze, IntrospectedTable introspectedTable) {
        ...
        interfaze.addJavaDocLine(" * @Date " + currentDateStr);
